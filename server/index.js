...
class BotHelper {
  ...
  // TODO: not sure if should allow this[prop]() - could be safer to only allow returning properties via get/set methods
  request(prop) {
  ...
  // TODO: remove unfiltered getters used to debug, only return specific properties
  get allUsers() {
